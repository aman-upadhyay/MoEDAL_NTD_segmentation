...
class DisplayCallback(tf.keras.callbacks.Callback):
	def on_epoch_end(self, epoch, logs=None):
		...
		show_prediction(train_dataset_c)
...
clean_array_80 = np.pad(clean_array_80, ((0, 0), (2, 2), (4, 4), (0, 0)), 'constant', constant_values=1)
...
clean_array_20 = np.pad(clean_array_20, ((0, 0), (2, 2), (4, 4), (0, 0)), 'constant', constant_values=1)
...
show_prediction(test_dataset_c, 4)
